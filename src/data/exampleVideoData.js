...
var exampleVideoData = [
  {
    ...
    snippet: {
      ...
      description:
        'My website - https://www.thenewboston.com/videos.php Have questions about the tutorial or React? Ask them here ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'A step by step video tutorial that takes you through the correct way of coding Facebook React views. Check out the rest of the tagtree library: http://tagtree.tv.',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'Get the full course here: http://devslopes.com/react In this video you will learn how to setup your project for React development and you will build a simple React ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "Hey! Write something in the comments, even if it's critical. I'd love to hear feedback! (also, please thumbs-up if you like the vid, and I'll make more). Personally I ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "Brought to you by Formidable Labs and SeattleJS, Colin Megill walks us through Facebook's React framework in part one of this three-part series. The workshop ...",
      thumbnails: {
        default: {
